  ...
  return (
    <>
      ...
      <div className="container bg-blue-50 mx-auto p-4">
        ...
        <h1 className="text-3 mb-6">Search a Product</h1>
        ...
        <div className="dropcontainer absolute w-[72vw] border-1 bg-blue-100 rounded-md ">
          ...
          {dropdown.map(item => {
            return <div key={item.slug} className="container flex justify-between p-2 my-1 border-b-2">
              ...
              <div className='mx-5'>
                <button onClick={() => { buttonAction("minus", item.slug, item.quantity) }} disabled={loadingaction} className="subtract inline-block px-3 py-1 cursor-pointer bg-purple-500 text-whi rounded-lg shadow-md disabled:bg-purple-200"> - </button>

                <span className="quantity inline-block  min-w-3 mx-3">{item.quantity}</span>
                <button onClick={() => { buttonAction("plus", item.slug, item.quantity) }} disabled={loadingaction} className="add inline-block px-3 py-1 cursor-pointer bg-purple-500 text-whi rounded-lg shadow-md disabled:bg-purple-200">  + </button>
      ...
      <div className="container bg-blue-50 mx-auto p-4">
        <h1 className="text-3 mb-6">Add a Product</h1>
        ...
        <form>
          ...
          <div className="mb-4">
            <label htmlFor="productName" className="block mb-2">Category</label>
            <input value={productForm?.category || ""} name='category' onChange={handleChange} type="text" id="productName" className="w-full border border-gray-300 px-4 py-2" />
          </div>
          ...
          <button onClick={addProduct} type="submit" className="bg-blue-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg shadow-">
            Add Product
          </button>
